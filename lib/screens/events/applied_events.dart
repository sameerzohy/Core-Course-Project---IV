...
class AppliedEvents extends StatefulWidget {
  ...
  @override
  State createState() => _AppliedEventsState();
}
      ...
      child: Container(
        ...
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (userData == null ||
                !userData.containsKey('registered_events') ||
                userData['registered_events'] == null) {
              return Center(child: Text('Not Registered to any Events!'));
            }
            ...
            if (userData['registered_events'] is Map) {
              eventsMap =
                  Map<String, dynamic>.from(userData['registered_events']);
            } else if (userData['registered_events'] is List) {
              // If it's actually a list, convert to original code
              List<dynamic> eventsList = userData['registered_events'];

              if (eventsList.isEmpty) {
                return Center(child: Text('No events Registered yet'));
              }
