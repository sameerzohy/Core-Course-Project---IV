...
class FavouriteEvents extends StatefulWidget {
  ...
  @override
  State createState() => _FavouriteEventsState();
}
      ...
      child: Container(
        ...
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (userData == null ||
                !userData.containsKey('favourite_events') ||
                userData['favourite_events'] == null) {
              return Center(child: Text('No Favourite Events!'));
            }
            ...
            if (userData['favourite_events'] is Map) {
              eventsMap =
                  Map<String, dynamic>.from(userData['favourite_events']);
            } else if (userData['favourite_events'] is List) {
              // If it's actually a list, convert to original code
              List<dynamic> eventsList = userData['favourite_events'];

              if (eventsList.isEmpty) {
                return Center(child: Text('No events Favourite yet'));
              }
